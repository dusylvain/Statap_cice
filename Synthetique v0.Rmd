...
synth.out$solution.w=opti$par#on remplace les poids par ceux calculés
...
```{r}
calculpoids=function(df.melted){
Xt=subset(df.melted, country=='FR'& temps<2013 &temps>1999)
Xt=Xt$value.y#on récupère les données pour la France
Xn=subset(df.melted, temps<2013 &temps>1999)
Xn=matrix(Xn$value.y, nrow=26)
Xn=Xn[c(1:11, 13:26),]#on récupère les autres
