...
df <- data.frame(x=1995:2015, data.frame(tabeleau))
...
```{r}
ligne_pays( capital, vari="Ip_OCon", codei='TOT', pays=c("FR", "DE", "UK", "ES", "IT") )+ ggtitle("évolution de l'investissement dans les grands pays européens") +
  xlab("année") + ylab("formation brute de capital fixe, base 2010=100")
```
```
...
ligne_pays( croiss, vari='LAB', codei='TOT', pays=c("FR", "DE", "UK", "ES", "IT") )+ ggtitle("évolution du coût du travail dans les grands pays européens") +
  xlab("année") + ylab("coût du travail")
```
