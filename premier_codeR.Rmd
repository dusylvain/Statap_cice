...
ligne_pays_bis( compte, vari='VA', codei='TOT', pays=c("FR", "DE", "UK", "ES", "IT"), variable='Valeur ajoutée', varbis="GDP", paysbis=c("AGO","ALB"), echelle=10**5 )
```
Attention, les données WB sont en milliards et les EU Klems en billions !
